<div wire:ignore class="card-body">
    <div class="card-header">
        <div class="row">
            <h5>Analisa Dan Perhitungan Trafo</h5>
        </div>
    </div>
    <table id="example1" class="table table-bordered table-head-fixed text-nowrap h6">
        <thead>
            <tr>
                ...
                <td width="1632" colspan="24">
                    <div align="center">ANALISA PERHITUNGAN TRAFO</div>
                </td>
            </tr>
            <tr>
                <td rowspan="3" width="1632">
                    <div align="center">JUMLAH<br />
                        JURUSAN</div>
                </td>
                <td rowspan="3" width="1632">
                ...
                <td colspan="2" rowspan="3" width="1632">
                    <div align="center">Umur<br />
                        Trafo</div>
                </td>
                <td colspan="8" width="1632">
                    <div align="center">BEBAN
                        JURUSAN</div>
                </td>
                <td colspan="6" rowspan="2" width="1632">
...
?>
            ...
            <tr>
                ...
                <td align="right">
                    <div align="center"></div>{{ $post->Master->tahun != '' ? $now->year - $post->Master->tahun : "-"  }}
                </td>
                <td align="right">
                    <div align="center"></div>Tahun
                </td>
