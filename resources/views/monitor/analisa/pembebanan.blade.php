<div class="card-body">
    <div class="card-header">
        <div class="row">
            <h5>ANALISA KONDISI PEMBEBANAN TRAFO </h5>
        </div>
    </div>

    <table id="example3" class="table table-bordered table-head-fixed text-nowrap h6">
        <thead>
            <tr>
                <td rowspan="2">
            ...
            <tr>
                <td width="1632">
                    <div align="center" style="width: 58px;">Siang</div>
                </td>
                <td width="1632">
                    <div align="center" style="width: 58px;">MALAM</div>
                </td>
                <td width="1632">
                    <div align="center" style="width: 58px;">REKAP</div>
                </td>
                <td width="1632">
                    <div align="center" style="width: 200px;">KESIMPULAN</div>
                </td>
            </tr>
            <tr>
                <td>
