    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form >
                <input name="ids" wire:model.defer="id" type="hidden" >
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    @error('id_nama') <span class="error text-danger">Id / Nama Sudah di gunakan</span> @enderror
                </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input wire:model.defer="ns_trafo" type="number" class="form-control"  autocomplete="off">
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kapasitas Trafo</label>
                  ...
                  {{-- <div class="form-group">
                    <label for="exampleInputEmail1">Nama Bengkel Revis Travo</label>
                    <input wire:model.defer="nama_bengkel" type="text" class="form-control"  autocomplete="off">
                  </div> --}}
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-dismiss="modal" wire:click.prevent="clear()">Close</button>
